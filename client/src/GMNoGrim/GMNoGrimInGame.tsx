...
import { GrimoireCircleTab } from "../GMRoute/GMInGame/Tabs/GrimoireCircleTab";
import { GrimoireTab } from "../GMRoute/GMInGame/Tabs/GrimoireTab";
import { MenuTab } from "../GMRoute/GMInGame/Tabs/MenuTab";
import { type PlayerOrder } from "../shared/PlayerListOrder";
import { SimpleNightOrderTab } from "./SimpleNightOrderTab";

type Tabs = "list-grimoire" | "night" | "grimoire-circle" | "menu";
export function GMNoGrimInGame() {
